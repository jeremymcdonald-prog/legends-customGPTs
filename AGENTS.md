...
15. The root `README.md` is generated by `scripts/generate_readme.rb`. Never edit it directly; update the canonical metadata or `config/readme_sections.yaml`, regenerate, and verify with `ruby scripts/generate_readme.rb --check`.
