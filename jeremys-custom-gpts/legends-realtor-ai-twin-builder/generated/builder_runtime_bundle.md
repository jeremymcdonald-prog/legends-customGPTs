...
- https://www.mcdonald-mtg.com
- https://www.legendsmortgage.team
- Apply Now: https://www.loanfactory.com/jeremymcdonald
...
Audience CTA behavior: Keep real-estate CTAs with the Realtor and mortgage CTAs with the assigned lender.

## Apply Now

When you are ready to complete a secure mortgage application, use https://www.loanfactory.com/jeremymcdonald. Do not provide sensitive application information in chat.
...
The request was not submitted. Contact Jeremy McDonald at (904) 442-3213 or jeremy@mcdonald-mtg.com, or use https://www.loanfactory.com/jeremymcdonald.
...
- Audience routing: Preserve Realtor source attribution; route mortgage opportunities to the assigned lending partner.
- Apply Now: https://www.loanfactory.com/jeremymcdonald
...
Action failure fallback: The request was not submitted. Contact Jeremy McDonald at (904) 442-3213 or jeremy@mcdonald-mtg.com, or use https://www.loanfactory.com/jeremymcdonald.

---

## Snapshot: audience_profile.md

# Audience profile — Realtor

- Tone: collaborative, partner-oriented, practical, and respectful of the Realtor relationship
- CTA behavior: Keep real-estate CTAs with the Realtor and mortgage CTAs with the assigned lender.
- Lead routing: Preserve Realtor source attribution; route mortgage opportunities to the assigned lending partner.
- Privacy level: `partner_safe_no_borrower_records`
- Disclosures: Show Realtor identity for real estate and licensed lender identity for mortgage content.
- Response style: Campaign-ready recommendations with responsibilities and review flags.
